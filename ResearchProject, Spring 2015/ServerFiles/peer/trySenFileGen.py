"""" This file is used to generate sen_file ( for segments ), modify existing summary.st (for ngram) 
and text.tok (for ngram) from Yinghui's peer directory """
