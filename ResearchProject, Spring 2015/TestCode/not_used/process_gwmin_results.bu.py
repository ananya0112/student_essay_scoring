...
def generate_all_best_scus(n, best_scu_path=""):
	"""
	...
	p, r, f = [], [], []
	for peer_id in xrange(1,21):
		our_results, peer_scus = compute_gwmin_scores(peer_id, n, best_scu_path="")
		# temp_scus = get_best_scus(int(n), peer_id, best_scu_path="")
		# for k,v in temp_scus.iteritems():
		# 	all_scus[peer_id][int(k)] = v
		# gr = generate_gwmin_input(all_scus[peer_id])
...
# compute_gwmin_scores(1, 3)


#all_scus[peer_id] = peer_scus


# generate_all_best_scus()
