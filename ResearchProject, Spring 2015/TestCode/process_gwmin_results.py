...
"""
NOTE: Temporarily, keeping it harcoded!
"""
...
#        print 'config-->', config.pan_file_path_parsed
...
#pan_peer_map = generate_pan_map()


def get_unique_values(d):
    val_list = []
    for value in d.values():
        # print "our values/", value
